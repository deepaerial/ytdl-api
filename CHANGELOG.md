...
## [1.12.0] - 2026-06-06
### Changed
- Migrated project from Poetry to uv: Dockerfile, CI/CD, scripts, config, and docs.
...
- Updated `fixtures.json` for tests.

## [1.9.0] - 2024-11-14
### Changed
- Submit endpoint no longer returns whole downloads list.

## [1.8.2] - 2024-11-10
### Changed
- Adapted project to new version of pydantic.

## [1.8.1] - 2024-11-03
### Fixed
- Improved error handling for yt-dlp downloader.
