        ...
        downloads = self.base.fetch(
            {
                ...
                "status?not_contains": [DownloadStatus.STARTED, DownloadStatus.DELETED, DownloadStatus.DOWNLOADING, DownloadStatus.CONVERTING],  # this condition seems not to work :(
            }
        ).items
        return parse_obj_as(list[Download], downloads)
